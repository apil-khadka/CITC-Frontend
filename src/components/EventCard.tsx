                    ...
                    {isRunning && event.registration_link && (
                        <div className="pt-4">
                            <a
                                ...
                                className="flex w-full items-center justify-center gap-2 rounded-xl bg-cyan-600 dark:bg-cyan-500 px-4 py-3 text-sm font-bold text-white transition-all hover:bg-cyan-700 dark:hover:bg-cyan-400 hover:shadow-lg hover:shadow-cyan-500/20"
                            >
